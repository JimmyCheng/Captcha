...
public class CaptchasDotNet {
	...
	public CaptchasDotNet(HttpSession httpSess, String client, String secret, String alphabet, int letters, int width,
			int height) {
		this.httpSess = httpSess;
		this.client = client;
		this.secret = secret;
	...
	/**
	 * Generate audio url with parameters same as image url without width and height
	 */
	...
	/**
	 * Check the CAPTCHA code Returns 3 errors codes s, m, w and t if successfull
	 */
